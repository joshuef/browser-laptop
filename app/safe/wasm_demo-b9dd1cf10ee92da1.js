...
function integrateWasmJS() {
  ...
  var wasmTextFile =
    Module["wasmTextFile"] || "wasm_demo-b9dd1cf10ee92da1.wast";
  var wasmBinaryFile =
    Module["wasmBinaryFile"] || "wasm_demo-b9dd1cf10ee92da1.wasm";
  var asmjsCodeFile =
    Module["asmjsCodeFile"] || "wasm_demo-b9dd1cf10ee92da1.temp.asm.js";
...
var _get_data = (Module["_get_data"] = function() {
  return Module["asm"]["_get_data"].apply(null, arguments);
});
...
function exit(status, implicit) {
  ...
  if (ENVIRONMENT_IS_NODE) {
    console.log("really making you quit eh");
    // process["exit"](status);
  }
